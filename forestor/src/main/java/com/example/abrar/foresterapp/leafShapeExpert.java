...
public class leafShapeExpert {    /* Exact match type expert */
    ...
    public static ArrayList<Integer> searchPlants(String value){
        ...
        //int column = 11; //the appropriate column for this expert!
        if (value.equals("N/A")) { //case for when user does not enter a value
            bestPlants.add(0);
            return bestPlants;
        }

        String[][] plantData = Plant.getPlants("leafShape"); //get data from database
