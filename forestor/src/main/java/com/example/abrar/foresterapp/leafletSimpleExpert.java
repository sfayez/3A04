...
public class leafletSimpleExpert { /* Exact match type expert */
    ...
    public static ArrayList<Integer> searchPlants(String value){
        ...
        //int column = 12; //the appropriate column for this expert!
        if (value.equals("N/A")) { //case for when user does not enter a value
            bestPlants.add(0);
            return bestPlants;
        }

        String[][] plantData = Plant.getPlants("leafletSimple"); //get data from database
